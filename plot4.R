...
plot(data_sub$Full_date, data_sub$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")
...
plot(data_sub$Full_date, data_sub$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global Reactive Power")
dev.off()